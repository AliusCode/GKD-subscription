...
本仓库主要为自用，所有规则均根据本人使用习惯进行了删减留存，由于@AIsouler仓库维护时间已有两年之久，产生了很多抽象或非主流APP（如动漫共和国、囧次元等广告多发且难以寻找节点）的规则，加之广告也在不断更新、变化，导致仓库臃肿难以维护，因此后续维护主要以主流APP为主，不再将类似APP合并至主分支，所有原仓库APP规则会经过筛选后逐步添加至本仓库。
