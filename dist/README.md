...
||||
| - |:-:|-|
|5EPlay|2|<li>局部广告-首页右下角浮窗<li>更新提示|
...
|bilibili|5|<li>评价提示-评论区满意度评价<li>评价提示-APP评分<li>通知提示-订阅感兴趣的通知<li>功能类-自动领取会员经验<li>功能类-自动关闭故事模式|
|Chrome|1|<li>功能类-文件可能有害-点击[仍然下载]|
|CSDN|5|<li>更新提示<li>分段广告-信息流广告<li>评价提示-软件好评弹窗<li>全屏广告-弹窗广告<li>分段广告-底部广告|
|Facebook|1|<li>功能类-自动点击[查看翻译]|
|FlowMark|1|<li>更新提示|
|Gmail|1|<li>分段广告-信息流广告|
|iGPSPORT|1|<li>更新提示|
|Instagram|2|<li>分段广告-信息流广告<li>功能类-自动点击[查看翻译]|
|Keep|4|<li>全屏广告-首页弹窗广告<li>局部广告-首页信息流广告<li>全屏广告-运动购页面-弹窗广告<li>更新提示|
|Oopz|1|<li>开屏广告|
...
|Soul|7|<li>开屏广告<li>局部广告-广场页卡片广告<li>评价提示-app评分<li>更新提示<li>局部广告-帖子详情页卡片广告<li>全屏广告-送礼开聊会话<li>全屏广告-推荐页领金币|
|Telegram|3|<li>其他-添加生日提示<li>局部广告-拍卖提示<li>其他-首页公告栏|
...
|WPS Office Lite|1|<li>全屏广告|
|YouTube|1|<li>全屏广告-会员广告|
|youtube|8|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>功能类-自动翻译评论<li>其他-关闭播放器辅助功能弹窗<li>功能类-关闭视频播放结束后的推荐视频<li>局部广告<li>分段广告-播放页广告|
...
|百度地图|5|<li>开屏广告<li>更新提示<li>功能类-通勤卡添加至桌面<li>全屏广告<li>局部广告|
|百度输入法|2|<li>全屏广告-创作祝福弹窗<li>局部广告-底部会员悬浮卡片|
|百度贴吧|12|<li>开屏广告<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗<li>局部广告-信息流广告<li>局部广告-感兴趣的吧推广|
|百度网盘|6|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>更新提示<li>评价提示<li>局部广告-悬浮广告<li>分段广告-暂不开启自动备份|
|百度网盘-三星版本|4|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>评价提示<li>功能类-[上新【专辑】功能]弹窗|
|班级小管家|1|<li>分段广告-卡片广告|
|宝宝树孕育|3|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-首页右侧悬浮广告|
|北京一卡通|2|<li>全屏广告-弹窗广告<li>功能类-跳过协议|
|币安|1|<li>更新提示|
|必剪|1|<li>更新提示|
|哔哩哔哩|19|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐卡片广告<li>更新提示<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>分段广告-首页推荐视频卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告<li>分段广告-视频详情页下方推广<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图<li>评价提示<li>功能类-直播自动点赞<li>功能类-直播自动投喂粉丝团|
...
|大学搜题酱|7|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>更新提示<li>评价提示-请求好评弹窗<li>全屏广告-邀好友得开学好礼<li>分段广告-底部卡片广告|
|电池容量检测管理|1|<li>全屏广告-弹窗广告|
|钉钉|5|<li>局部广告-消息列表上方广告<li>功能类-文件即将过期提示<li>功能类-自动点击原图<li>更新提示<li>功能类-扫码自动登录桌面版|
|东莞通|2|<li>局部广告<li>全屏广告|
|斗鱼|1|<li>局部广告-直播间广告|
|鄂汇办|1|<li>开屏广告|
|番茄免费小说|10|<li>开屏广告<li>局部广告-阅读页面广告<li>更新提示<li>局部广告-首页右侧悬浮广告<li>全屏广告<li>全屏广告-阅读页面关注作者弹窗<li>分段广告-阅读页面广告<li>评价提示-请求好评弹窗<li>功能类-观看广告自动领取奖励<li>评价提示-点评此书弹窗|
...
|高德地图|8|<li>开屏广告<li>更新提示<li>功能类-截屏分享<li>局部广告-首页上方消息提醒<li>局部广告-首页签到卡片<li>局部广告-卡片广告<li>全屏广告<li>功能类-一键点亮角落|
...
|金山文档|2|<li>局部广告-列表卡片广告<li>更新提示|
|囧次元|4|<li>全屏广告-弹窗广告<li>全屏广告-开屏广告<li>功能类-立即签到<li>功能类-领取VIP|
|开发助手|1|<li>局部广告-卡片广告|
|看护家|1|<li>全屏广告-弹窗广告|
...
|拼多多|12|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮广告<li>局部广告-商品详情页视频讲解窗口<li>功能类-多多视频每日自动签到<li>全屏广告-多多视频划到广告自动跳过<li>功能类-发送图片时自动勾选原图<li>全屏广告-下单后出现的弹窗<li>青少年模式<li>全屏广告-[个性化推荐]弹窗<li>其他-登录提现页面点击[跳过]<li>功能类-关闭截图后的弹窗|
|企查查|1|<li>全屏广告-VIP弹窗|
|青藤之恋|1|<li>评价提示-好评弹窗|
|蜻蜓FM|1|<li>局部广告-播放界面的广告|
|全知识|1|<li>局部广告-左下角参与答题卡片|
...
|淘宝闪购|8|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片|
...
|微信|25|<li>分段广告-朋友圈广告<li>功能类-电脑微信快捷自动登录<li>功能类-自动授权登录<li>功能类-自动领取微信红包<li>功能类-自动选中发送原图<li>功能类-自动查看原图/视频<li>开屏广告-微信小程序<li>功能类-网页版文件传输助手扫码自动授权<li>青少年模式<li>局部广告-订阅号消息-推荐文章<li>功能类-付款后自动点击完成/返回商家<li>分段广告-订阅号消息-视频推荐<li>功能类-解锁 Windows 微信<li>全屏广告-文档页面-腾讯文档APP弹窗<li>分段广告-订阅号消息-推荐阅读<li>功能类-付款时自动点击[支付]<li>分段广告-公众号文章内广告<li>全屏广告-小程序弹窗广告<li>功能类-自动语音转文字<li>功能类-语音/视频通话呼入10秒后自动点击接听<li>功能类-点击语音条菜单里的转文字<li>功能类-自动允许打开外部应用<li>全屏广告-小程序奖励形广告关闭<li>功能类-小米社区小程序【去签到】<li>功能类-小米社区小程序【自动登录】|
|微众银行|1|<li>全屏广告|
|我的听书|3|<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>分段广告-播放页卡片广告|
|喜马拉雅|6|<li>局部广告-播放页广告<li>分段广告-信息流广告<li>青少年模式<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>全屏广告-免流提示|
...
|小包搜题|1|<li>局部广告-卡片广告|
|小红书|9|<li>开屏广告<li>更新提示<li>分段广告-信息流广告<li>全屏广告-优惠券弹窗<li>评价提示-评分弹窗<li>功能类-评论区-自动展开回复<li>局部广告-你可能感兴趣的人<li>局部广告-关闭首页信息流中推荐博主<li>局部广告-直播间各种卡片|
...
|小米社区|5|<li>更新提示<li>局部广告-评论区卡片广告<li>全屏广告-签到弹窗<li>全屏广告-公告板弹窗<li>功能类-立即签到|
|小米音箱|1|<li>全屏广告-首页弹窗广告|
|小米应用商店|6|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>功能类-忽略升级<li>局部广告-个性化推荐卡片<li>功能类-自动点击[查看全部升级]<li>功能类-移动数据更新弹窗点击继续|
...
|迅雷|5|<li>开屏广告<li>分段广告<li>全屏广告<li>更新提示<li>局部广告-卡片广告|
|迅游手游加速器|1|<li>分段广告-卡片广告|
|央视新闻|2|<li>局部广告-卡片广告<li>功能类-个性化推荐弹窗|
|一个木函|1|<li>局部广告|
|一刻相册|8|<li>开屏广告<li>更新提示-软件升级提醒<li>局部广告-悬浮窗广告<li>评价提示<li>全屏广告-会员弹窗<li>全屏广告-弹窗广告<li>局部广告-照片页底部浮窗广告<li>局部广告-卡片广告|
...
|云蚁物联|2|<li>全屏广告<li>局部广告|
|运动世界|4|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>分段广告-卡片广告<li>通知提示-公告|
|招商银行|2|<li>局部广告-首页活动悬浮广告<li>全屏广告-弹窗广告|
|支付宝|23|<li>全屏广告-关闭花呗升级弹窗<li>更新提示-版本更新弹窗<li>全屏广告-小组件弹窗<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-弹窗广告<li>全屏广告-支付后的推荐弹窗<li>分段广告-扫码乘车后出现的广告<li>全屏广告-关闭免密支付广告<li>分段广告-服务消息页面卡片广告<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗<li>全屏广告-[银行卡还款服务升级]弹窗<li>开屏广告-小程序开屏广告<li>功能类-自动授权登录<li>局部广告-直播悬浮窗<li>功能类-余额宝转出自动勾选[短期不再提示]<li>功能类-自动领取会员积分<li>功能类-无法访问时点击[返回]<li>其他-滑动验证时返回<li>其他-开通刷脸支付弹窗<li>功能类-确认清理已选中的缓存<li>青少年模式|
|知到|3|<li>更新提示<li>通知提示-课程提醒<li>通知提示-AI分析|
|知乎|10|<li>开屏广告<li>分段广告-信息流广告<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>局部广告-信息流广告<li>局部广告-悬浮广告<li>更新提示<li>功能类-热榜页自动点击[展开更多]<li>功能类-自动展开回答<li>评价提示-评论区氛围评价卡片|
...
|中国农业银行|2|<li>开屏广告<li>更新提示|
|中国移动|5|<li>开屏广告<li>更新提示<li>全屏广告-首页弹窗广告<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗|
|中国邮政|1|<li>全屏广告-首页弹窗|
|中羽在线|1|<li>全屏广告-弹窗广告|
...
|最右|3|<li>开屏广告<li>更新提示<li>分段广告-评论区卡片广告|
|作业帮|1|<li>全屏广告-弹窗广告|
...
|PU口袋校园|3|<li>全屏广告-弹窗广告<li>局部广告-首页-右侧浮窗广告<li>功能类-打开应用自动进入部落|
|realme社区|1|<li>功能类-自动签到|
|UC浏览器|3|<li>开屏广告<li>分段广告-信息流广告<li>其他-请求添加桌面快捷方式弹窗|
